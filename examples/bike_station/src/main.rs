...
async fn database_setup(client: &Client) -> Result<(), Box<dyn Error>> {
    let queries = &[
        ...
        "insert into bike_station_app.station_measure (station_id, probed_at, total_slots, working_slots, available_slots) values (4,'2022-12-02 13:33:53+00',15,15,9), (4,'2022-12-02 13:37:06+00',15,15,11), (4,'2022-12-02 13:40:19+00',15,15,13), (4,'2022-12-02 13:43:32+00',15,15,12), (4,'2022-12-02 13:46:45+00',15,15,11)",
    ];
    for sql in queries {
